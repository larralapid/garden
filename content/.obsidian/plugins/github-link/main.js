...
var GithubLinkPluginSettingsTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Status tooltips").setDesc("Add a tooltip to issue and pull request status icons with status text").addToggle((toggle) => {
...
async function renderTable(params, result, el, renderFn) {
  ...
  if (params.refresh) {
    ...
    (0, import_obsidian8.setIcon)(refreshButton, "refresh-cw");
  }
...
function createInlineViewPlugin(_plugin) {
  class InlineViewPluginValue {
    ...
    isLivePreview(state) {
      return state.field(import_obsidian9.editorLivePreviewField);
    }
