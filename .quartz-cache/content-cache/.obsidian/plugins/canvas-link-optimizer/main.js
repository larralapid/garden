  ...
  patchLinkNode(constructor) {
    ...
    const uninstaller = around(constructor.prototype, {
      ...
      initialize: (next) => function(...args) {
        ...
        const saveThumbnail = (0, import_obsidian.debounce)(() => this._saveThumbnail(), 500);
        ...
        (async () => {
          ...
          this._perviewImageEl.src = thisPlugin.app.vault.adapter.getResourcePath(this._getThumbnailPath());
